...
+ Beheren, werk - tussenliggend {#manage-work-intermediate}
   ...
   + Erkenningsprocessen maken en gebruiken {#how-to-create-and-use-approval-processes}
   ...
   + Hoe te met kwesties werken {#how-to-work-with-issues}
